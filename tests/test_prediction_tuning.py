...
class PredictionTuningTest(unittest.TestCase):
    ...
    def test_entry_and_history_rates_are_kept_separate(
        ...
        self.assertEqual(MODEL_VERSION, "explainable-v6")
        ...
        self.assertAlmostEqual(scored[0]["base_score"], 75.21, places=2)
        self.assertGreater(scored[0]["new_data_axis_score"], 0)
        self.assertGreater(scored[0]["new_data_place_score"], 0)
        self.assertGreater(scored[0]["new_data_role_fit"], 0)
